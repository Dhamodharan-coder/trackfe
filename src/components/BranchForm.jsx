...
const BranchForm = () => {
    ...
    const formik = useFormik({
      ...
      validate: (values) => {
        ...
        // // Validate branchdetails
        // if (!values.branchdetails) {
        ...
        //   if (!branchcode) errors.branchdetails = { ...errors.branchdetails, branchcode: 'Branch code is required' };
        //   if (!branchname) errors.branchdetails = { ...errors.branchdetails, branchname: 'Branch name is required' };
        //   if (!branchshortname) errors.branchdetails = { ...errors.branchdetails, branchshortname: 'Branch shortname is required' };
        //   if (!doorflatno) errors.branchdetails = { ...errors.branchdetails, doorflatno: 'Door/Flat No is required' };
        //   if (!street) errors.branchdetails = { ...errors.branchdetails, street: 'Street is required' };
        //   if (!pincode || !/^\d{6}$/.test(pincode)) errors.branchdetails = { ...errors.branchdetails, pincode: 'Invalid pincode' };
        //   if (!locality) errors.branchdetails = { ...errors.branchdetails, locality: 'Locality is required' };
        //   if (!city) errors.branchdetails = { ...errors.branchdetails, city: 'City is required' };
        //   if (!state) errors.branchdetails = { ...errors.branchdetails, state: 'State is required' };
        //   if (!panNo || panNo.length !== 10) errors.branchdetails = { ...errors.branchdetails, panNo: 'PAN number must be 10 characters' };
        //   if (!gstin || gstin.length !== 15) errors.branchdetails = { ...errors.branchdetails, gstin: 'GSTIN must be 15 characters' };
        //   if (!branchtType) errors.branchdetails = { ...errors.branchdetails, branchtType: 'Branch type is required' };
        //   if (!vehicleType || vehicleType.length < 1) errors.branchdetails = { ...errors.branchdetails, vehicleType: 'At least one vehicle type is required' };
        // }
      
        // // Validate branchcontactdetails
        // if (!values.branchcontactdetails) {
        //   errors.branchcontactdetails = 'Branch contact details are required';
        // } else {
        //   const { contactno, alternatecontactno, whatsappno, emailid } = values.branchcontactdetails;
      
        //   if (!contactno || !/^\d{10}$/.test(contactno)) errors.branchcontactdetails = { ...errors.branchcontactdetails, contactno: 'Invalid contact number' };
        //   if (alternatecontactno && !/^\d{10}$/.test(alternatecontactno)) errors.branchcontactdetails = { ...errors.branchcontactdetails, alternatecontactno: 'Invalid alternate contact number' };
        //   if (whatsappno && !/^\d{10}$/.test(whatsappno)) errors.branchcontactdetails = { ...errors.branchcontactdetails, whatsappno: 'Invalid WhatsApp number' };
        //   if (!emailid || !/\S+@\S+\.\S+/.test(emailid)) errors.branchcontactdetails = { ...errors.branchcontactdetails, emailid: 'Invalid email address' };
        // }
      
        // // Validate openingdetails
        // if (!values.openingdetails) {
        //   errors.openingdetails = 'Opening details are required';
        // } else {
        //   const { openingbalance, openingdate } = values.openingdetails;
      
        //   if (openingbalance <= 0) errors.openingdetails = { ...errors.openingdetails, openingbalance: 'Opening balance must be positive' };
        //   if (!openingdate) errors.openingdetails = { ...errors.openingdetails, openingdate: 'Opening date is required' };
        // }
      
        // // Validate advancerequestdetails
        // if (!values.advancerequestdetails) {
        //   errors.advancerequestdetails = 'Advance request details are required';
        // } else {
        //   const { minimumamount, maximumamount, monthlymaximumamount, maximumunallocatedamount, effectivedate } = values.advancerequestdetails;
      
        //   if (minimumamount <= 0) errors.advancerequestdetails = { ...errors.advancerequestdetails, minimumamount: 'Amount must be positive' };
        //   if (maximumamount <= 0) errors.advancerequestdetails = { ...errors.advancerequestdetails, maximumamount: 'Amount must be positive' };
        //   if (monthlymaximumamount <= 0) errors.advancerequestdetails = { ...errors.advancerequestdetails, monthlymaximumamount: 'Amount must be positive' };
        //   if (maximumunallocatedamount <= 0) errors.advancerequestdetails = { ...errors.advancerequestdetails, maximumunallocatedamount: 'Amount must be positive' };
        //   if (!effectivedate) errors.advancerequestdetails = { ...errors.advancerequestdetails, effectivedate: 'Effective date is required' };
        // }
      ...
      onSubmit: async (values) => {
       try {
        ...
        await axios.post("https://trackbe.onrender.com/branches",values,{
            headers:{
...
<div>
    <input type='submit' className='bg-purple-900 text-white px-4 py-2 rounded-lg cursor-pointer' />
</div>
